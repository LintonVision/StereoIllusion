...
Screen('DrawDots', win, 1.5*targetDots', 3, [255 255 255]);

glTranslatef(0, 5-50/40*2*5, 10);
Screen('DrawDots', win, 40/50*1.5*targetDots', 3, [255 255 255]);

glTranslatef(0, -5, 10);
Screen('DrawDots', win, 30/50*1.5*targetDots', 3, [255 255 255]);
...
%DRAW FRAME
glTranslatef(0.5*IPD, 0, viewingDist-Dist2);
Screen('FillPoly', win, [0 0 0], 1.5*backCircle');
Screen('DrawDots', win, 1.5*0.95*backDots', 3, [255 255 255]);
Screen('FillPoly', win, [0 0 0], 1.5*backRing');

%DRAW FRAME
glTranslatef(0, 0, Dist2-Dist3B);
Screen('FillPoly', win, [0 0 0], 1.5*frontCircle'*30/40);
Screen('DrawDots', win, 1.5*0.95*frontDots'*30/40, 3, [255 255 255]);
Screen('FillPoly', win, [0 0 0], 1.5*frontRing'*30/40);
